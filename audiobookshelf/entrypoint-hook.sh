...
export ABS_SETTINGS_SORTING_IGNORE_PREFIX="${ABS_SETTINGS_SORTING_IGNORE_PREFIX:-false}"
export ABS_SETTINGS_SORTING_PREFIXES="${ABS_SETTINGS_SORTING_PREFIXES:-"\"the\", \"a\""}"
export ABS_SETTINGS_SCANNER_PARSE_SUBTITLE="${ABS_SETTINGS_SCANNER_PARSE_SUBTITLE:-false}"
export ABS_SETTINGS_SCANNER_FIND_COVERS="${ABS_SETTINGS_SCANNER_FIND_COVERS:-false}"
export ABS_SETTINGS_SCANNER_COVER_PROVIDER="${ABS_SETTINGS_SCANNER_COVER_PROVIDER:-"google"}"
export ABS_SETTINGS_SCANNER_PREFER_MATCHED_METADATA="${ABS_SETTINGS_SCANNER_PREFER_MATCHED_METADATA:-false}"
...
export ABS_SETTINGS_RATE_LIMIT_LOGIN_REQUESTS="${ABS_SETTINGS_RATE_LIMIT_LOGIN_REQUESTS:-"10"}"
export ABS_SETTINGS_RATE_LIMIT_LOGIN_WINDOW="${ABS_SETTINGS_RATE_LIMIT_LOGIN_WINDOW:-"600000"}"
export ABS_SETTINGS_LOGGER_DAILY_LOGS_TO_KEEP="${ABS_SETTINGS_LOGGER_DAILY_LOGS_TO_KEEP:-"7"}"
export ABS_SETTINGS_LOGGER_SCANNER_LOGS_TO_KEEP="${ABS_SETTINGS_LOGGER_SCANNER_LOGS_TO_KEEP:-"2"}"
export ABS_SETTINGS_LOG_LEVEL="${ABS_SETTINGS_LOG_LEVEL:-"2"}"
